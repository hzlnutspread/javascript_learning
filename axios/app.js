...
// -------------------------------PUT/PATCH REQUEST-------------------------------
// Put request will replace everything
// Patch request will update and keep existing 
  function updateTodo() {
...
// -------------------------------TRANSFORMING REQUESTS & RESPONSES-------------------------------
  function transformResponse() {
    const options = {
        ...
        url: 'https://jsonplaceholder.typicode.com/todos',
        data: {
            title: 'Hello this is a transform thing'
        },
  ...
  function errorHandling() {
    axios.get('https://jsonplaceholder.typicode.com/todoss', {
        validateStatus: function(status) {
            //  Will only reject if status is greater or equal to 501
            return status < 501; 
        }
    })
    .then(res => showOutput(res))
